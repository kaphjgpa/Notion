  ...
  return (
    <>
      <aside
        ...
        <div className="mt-4">
          <DocumentList />
          <Item onClick={handleCreate} icon={Plus} lable="Add a page" />
          <Popover>
      ...
      <div
        ...
        {/* <div className="bg-transparent px-2 mt-1 py-2 w-full">
          <ChevronsRight
            role="button"
            onClick={resetWidth}
            className="h-6 w-6 rounded-sm text-muted-foreground hover:bg-neutral-300 dark:hover:bg-neutral-600 transition"
          />
        </div> */}
      </div>
    </>
